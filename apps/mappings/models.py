...
class GeneralMapping(models.Model):
    ...
    payment_account_id = models.CharField(max_length=255, help_text='Sage Payment Account id', null=True)
    payment_account_name = models.CharField(max_length=255,help_text='Sage Payment Account name', null=True)
