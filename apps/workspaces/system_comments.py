...
def create_filtered_system_comments(
    ...
    :param is_exported_to_intacct: whether the export was successful
    :return: None
    """
    ...
    for comment in system_comments:
        ...
        if is_exported_to_intacct or comment.get('persist_without_export', True):
