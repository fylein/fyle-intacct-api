# Generated by Django 3.1.13 on 2021-12-22 08:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_payment_type', models.CharField(help_text='Expense Payment Type', max_length=255, null=True)),
                ...
                ('journal_entry', models.ForeignKey(help_text='Reference to Bill', on_delete=django.db.models.deletion.PROTECT, to='sage_intacct.bill')),
            ],
            options={
