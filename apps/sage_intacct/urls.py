...
from .views import EmployeeView, VendorView, AccountView, ExpenseTypeView, ChargeCardAccountView, DepartmentView, \
    ...
    ChargeCardTransactionsView, ChargeCardTransactionsScheduleView, SageIntacctFieldsView, PaymentAccountView, ReimburseSagePaymentsView
...
urlpatterns = [
    ...
    path('bill_payment_accounts/', PaymentAccountView.as_view()),
    path('reimburse_payments/', ReimburseSagePaymentsView.as_view()),
]
