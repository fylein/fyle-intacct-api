...
def get_user_defined_dimension_object(expense_group: ExpenseGroup, lineitem: Expense) -> list:
    ...
    default_destination_attributes = ['ITEM', 'CLASS', 'DEPARTMENT', 'LOCATION', 'PROJECT', 'EXPENSE_TYPE', 'CHARGE_CARD_NUMBER',
...
class ChargeCardTransaction(models.Model):
    ...
    @staticmethod
    def create_charge_card_transaction(expense_group: ExpenseGroup, vendor_id: str = None, supdoc_id: str = None, system_comments: list = None) -> 'ChargeCardTransaction':
        """
