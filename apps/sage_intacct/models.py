...
class BillLineitem(models.Model):
    ...
    memo = models.TextField(help_text='Sage Intacct lineitem description', max_length=255, null=True)
...
class ExpenseReport(models.Model):
    ...
    memo = models.TextField(max_length=255, help_text='Sage Intacct memo', null=True)
    currency = models.CharField(max_length=5, help_text='Expense Report Currency')
    supdoc_id = models.CharField(help_text='Sage Intacct Attachments ID', max_length=255, null=True)
