    ...
    def create_journal_entry_lineitems(expense_group: ExpenseGroup, configuration: Configuration, sage_intacct_connection):
        ...
        for lineitem in expenses:
            ...
            if settings.BRAND_ID == 'fyle':
                ...
                employee_id = entity.destination_employee.destination_id if entity and employee_mapping_setting == 'EMPLOYEE' else None

                vendor_id = entity.destination_vendor.destination_id if entity and employee_mapping_setting == 'VENDOR' else None
