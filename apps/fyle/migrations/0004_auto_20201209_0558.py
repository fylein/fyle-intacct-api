...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('fyle', '0003_expensegroup_exported_at'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_state', models.CharField(default=apps.fyle.models.get_default_expense_state, help_text='state at which the expenses are fetched ( PAYMENT_PROCESSING / PAID)', max_length=100)),
