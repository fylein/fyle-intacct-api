...
export DB_SCHEMA=POSTGRES DB SCHEMA
...
export SI_USER_ID=SAGE INTACCT USER ID
export SI_COMPANY_ID=SAGE INTACCT COMPANY ID
export SI_USER_PASSWORD=SAGE INTACCT USER PASSWORD