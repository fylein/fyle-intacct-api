...
left join destination_attributes ndeh on (
    deh.destination_id = ndeh.destination_id and ndeh.attribute_type = 'EXPENSE_TYPE' and ndeh.workspace_id = deh.workspace_id
)
where da.attribute_type in ('CCC_ACCOUNT', 'ACCOUNT')
or deh.attribute_type in ('EXPENSE_TYPE');
