...
class TestAPPaymentsPost(BaseTestPost):
    ...
    def test_post(self, rest_client: RestClient, soap_client: SoapClient) -> None:
        ...
        rest_ap_payment_get_response = self.get_rest_get_response(ap_payments_rest_module, rest_ap_payment_object_id)
        soap_ap_payment_get_response = self.get_soap_get_response(ap_payments_soap_module, soap_ap_payment_object_id)

        self.assert_post_response(rest_ap_payment_get_response, soap_ap_payment_get_response)
    ...
    def get_ap_payments_soap_object_id(self, response: dict) -> str:
        ...
        :return: AP Payment ID
        """
        return response['data']['appymt']['RECORDNO']