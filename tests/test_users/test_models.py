...
def test_create_user(db):
    ...
    user = User.objects.create_user(email='sample@fyle.in', full_name='sample', password='samp')
...
def test_create_staffuser(db):
    ...
    Test Post of User Profile
    """
    user = User.objects.create_staffuser(email='sample@fyle.in', full_name='sample', password='samp')
    assert user.email == 'sample@fyle.in'
...
def test_create_superuser(db):
    ...
    Test Post of User Profile
    """
    user = User.objects.create_superuser(email='sample@fyle.in', full_name='sample', password='samp')
    assert user.email == 'sample@fyle.in'
