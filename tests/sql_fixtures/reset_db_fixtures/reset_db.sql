...
--
-- Name: intacct_company_tokens; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.intacct_company_tokens (
    id integer NOT NULL,
...
ALTER TABLE public.intacct_company_tokens OWNER TO postgres;

--
-- Name: intacct_company_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.intacct_company_tokens ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.intacct_company_tokens_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
229	Can add intacct company token	58	add_intacctcompanytoken
230	Can change intacct company token	58	change_intacctcompanytoken
231	Can delete intacct company token	58	delete_intacctcompanytoken
232	Can view intacct company token	58	view_intacctcompanytoken
\.
...
58	workspaces	intacctcompanytoken
\.
...
274	internal	0027_auto_generated_sql	2025-12-11 07:36:29.148276+00
275	workspaces	0058_intacctcompanytoken_and_more	2025-12-11 07:36:29.182334+00
276	workspaces	0059_remove_sageintacctcredential_access_token_and_more	2025-12-11 07:36:29.216151+00
\.
...
--
-- Data for Name: intacct_company_tokens; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.intacct_company_tokens (id, company_id, refresh_token, access_token, access_token_expires_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.sage_intacct_credentials (id, si_user_id, si_company_id, si_company_name, si_user_password, created_at, updated_at, workspace_id, is_expired, company_token_id) FROM stdin;
...
--
-- Name: intacct_company_tokens_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.intacct_company_tokens_id_seq', 1, false);
...
--
-- Name: intacct_company_tokens intacct_company_tokens_company_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.intacct_company_tokens
    ADD CONSTRAINT intacct_company_tokens_company_id_key UNIQUE (company_id);


--
-- Name: intacct_company_tokens intacct_company_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.intacct_company_tokens
    ADD CONSTRAINT intacct_company_tokens_pkey PRIMARY KEY (id);
...
--
-- Name: intacct_company_tokens_company_id_b67fea99_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX intacct_company_tokens_company_id_b67fea99_like ON public.intacct_company_tokens USING btree (company_id varchar_pattern_ops);
...
--
-- Name: sage_intacct_credentials_company_token_id_771789e9; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sage_intacct_credentials_company_token_id_771789e9 ON public.sage_intacct_credentials USING btree (company_token_id);
...
--
-- Name: sage_intacct_credentials sage_intacct_credent_company_token_id_771789e9_fk_intacct_c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sage_intacct_credentials
    ADD CONSTRAINT sage_intacct_credent_company_token_id_771789e9_fk_intacct_c FOREIGN KEY (company_token_id) REFERENCES public.intacct_company_tokens(id) DEFERRABLE INITIALLY DEFERRED;
